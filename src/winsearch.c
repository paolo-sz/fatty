...
(win_toggle_search)(struct term* term_p, bool show, bool focus)
{
  ...
  while (search_bar && * search_bar) {
    switch (* search_bar) {
      ...
      when 0x25B2 ... 0x25B5 case_or 0x25C0 ... 0x25C5:
        place_field(& barpos, button_width, & pos_prev);
        * prev_but = * search_bar;
      when 0x25B6 ... 0x25BF:
        place_field(& barpos, button_width, & pos_next);
        * next_but = * search_bar;
      when 0x2190 ... 0x2193 case_or 0x21D0 ... 0x21D3 case_or 0x21E0 ... 0x21E3
        case_or 0x21E6 ... 0x21E9 case_or 0x261C ... 0x261F:
      ...
      when 0x21FD case_or 0x21FE case_or 0x27F5 case_or 0x27F6 case_or 0x261A case_or 0x261B:
      ...
      when 0x2717 case_or 0x2718 /*or 0x274C or 0x2573*/:
        place_field(& barpos, button_width, & pos_close);
